                            ...
                            {openModal === 'hpan' && (
                                <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-40 p-2 md:p-0">
                                    <div className="bg-[#97d9f9]/20 backdrop-blur-3xl border-[1px] border-[#42a8ef] rounded-xl p-2 md:p-6 max-w-full w-full md:max-w-[90vw] shadow-lg flex flex-col items-center mx-auto">
                                        ...
                                        <h3 className="p-2 md:p-3 mb-2 md:mb-4 text-center text-[5vw] sm:text-[1.3em] md:text-[2em] lg:text-[2.2em] font-bebas text-[#e8f3fa] leading-tight">
                                            Ahora mismo además de felicitarte quiero darte las gracias no tienes idea de lo agradecido que estoy de poder tenerte en mi vida. Tanto yo como mis padres estamos bendecidos por tener la posibilidad de que estes presente en nuestro día a día. Desde que apareciste has llenado mi vida de alegría, de entusiasmo y sobretodo me has enseñado lo que es vivir en felicidad, en seguridad y con la confianza de ser mi mismo sabiendo que soy amado por una persona tan maravillosa como tu. <br /> <br />Sirley desde lo más profundo de mi corazón, te amo y te adoro como nunca a nadie en mi vida. Eres la luz que me ilumina y me mantiene con ganas de querer vivir día tras día. Espero que podamos seguir juntos mucho, mucho tiempo más y espero poder siempre hacerte feliz y hacerte sentir la mujer más especial del mundo. Te amo, mi amor. <br /> <br /> <strong className="font-extrabold text-[2em]">Tu y yo estamos hechos el uno para el otro. Te Pi 🎨</strong>
                                        </h3>
                                        <button onClick={() => setOpenModal(null)} className="px-6 md:px-8 py-2 md:py-1 backdrop-blur-md border-[1px] border-[#42a8ef] rounded-full hover:bg-gray-400 transition font-bebas text-[5vw] md:text-[2em] text-[#f1f7fa] mt-2">Salir</button>
                                    </div>
                                </div>
                                    ...
                                    <div className="bg-yellow-900/60 backdrop-blur-3xl border-[1px] border-yellow-900 rounded-xl p-2 md:p-6 max-w-full w-full md:max-w-[90vw] shadow-lg flex flex-col items-center mx-auto">
                                        ...
                                        <div className="flex rounded-3xl overflow-hidden">
                                            ...
                                            <h3 className=" p-2 md:p-3 mb-2 md:mb-4 text-center text-[12vw] sm:text-[1.3em] md:text-[2em] lg:text-[2.2em] font-bebas text-[#e8f3fa] leading-tight">
                                                ...
                                                <br />
                                                <p className="text-[3em]">Feliz Cumpleaños!!!</p> <br /> <br />A esa niña tan especial que Dios me le de muchos años más acompañandonos de bendiciones y mucha salud. <br />
                                ...
                                <div className="fixed inset-0 z-50 flex items-center justify-center bg-green-900 bg-opacity-40 p-2 md:p-0">
                                    <div className="bg-green-900/60 backdrop-blur-3xl border-[1px] border-green-900 rounded-xl p-2 md:p-6 max-w-full w-full md:max-w-[90vw] shadow-lg flex flex-col items-center mx-auto">
                                        ...
                                        <div className="flex  overflow-hidden gap-2 pb-5">
                                            ...
                                            <h3 className="p-2 md:p-3 mb-2 md:mb-4 text-center text-[5vw] sm:text-[1.3em] md:text-[2em] lg:text-[3.4em] font-bebas text-[#e8f3fa] leading-tight">Feliz vuelta al Sol Hija <br />  <br />Hoy hace 21 años llegaste a mi vida para saber cual hermoso y verdadero es el amor. <br />Le doy gracios a Dios por tu hermosa vida que me dio y el privilegio de ser tu madre. Y tener una hija tan maravillosa, hermosa, sabia, talentosa, inteligente, juiciosa y con un corazon hermoso. <br /><br />   Quiero desearte un gran dia y años de vida llenos de mucha prosperidad, cero miedos, proyectos, amor, salud, metas, paz mental, abundancia y logros cumplidos. <br />Siempre de la mano de nuestro padre Jesucristo. <br /><br />TE AMO CON EL CORAZON </h3>
